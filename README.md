...
- 🌡️ **Измерение температуры** — поддержка датчика Pt100 через MAX31865
...
- **Датчик температуры** — Pt100 с модулем MAX31865 (SPI)
  - CS: `GPIO5`
  - MOSI: `GPIO23`
  - MISO: `GPIO19`
  - SCK: `GPIO18`
...
- Чтение температуры с датчика Pt100 через MAX31865
...
[Информация о том, как внести свой вклад]
